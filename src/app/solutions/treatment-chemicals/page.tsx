              ...
              <div className="relative group">
                ...
                <div className="absolute top-full left-0 mt-2 w-56 bg-white rounded-md shadow-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200">
                  <div className="py-2">
                    ...
                    <Link href="/solutions/treatment-chemicals" className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-50 bg-yellow-50">
                      Treatment Chemicals
                    </Link>
                  ...
                  <div className="flex flex-col space-y-6 mt-8">
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="pl-4 space-y-2">
                        ...
                        <Link href="/solutions/treatment-chemicals" className="block text-yellow-600 hover:text-gray-900 font-medium">
                          Treatment Chemicals
                        </Link>
